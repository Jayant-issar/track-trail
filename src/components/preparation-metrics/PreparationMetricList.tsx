      ...
      {metrics.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {metrics.map((metric) => (
            <Card 
            key={metric.id}
            onClick={() => navigate(`/prep-tracker/detailed/${metric.id}`)}
            className="bg-gray-800/50 border-gray-700 group hover:border-purple-500/30 transition-colors cursor-pointer">
              ...
              >
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    handleProgressSubmit(metric.id);
                  }}
